...
<body>
	...
	<div id="adddlg" class="easyui-dialog" title="菜单" style="width:250px;height:250px;padding:10px"
			data-options="
				iconCls: 'icon-add',
				closed: true,
				buttons: '#dlg-buttons'
...
function addpermission(){
	//$.messager.alert('提示',$("#parentcode").combotree('getValues')+"");
...
function deletepermission(){
	var row = $('#tt').tree('getSelected');
	if (row){
		$.messager.confirm('删除菜单', "确定删除"+row.text+"吗?", function(r){
				if (r){
...
function tablemode(){
	document.location.href="permissionmanage.jsp";
}　
</script>